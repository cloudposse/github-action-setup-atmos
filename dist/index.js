...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getDownloadUrl = exports.downloadAtmos = void 0;
const fs_1 = __importDefault(__nccwpck_require__(7147));
const axios_1 = __importDefault(__nccwpck_require__(8757));
const path_1 = __importDefault(__nccwpck_require__(1017));
const downloadAtmos = (version, os, arch, outputPath = "./atmos") => __awaiter(void 0, void 0, void 0, function* () {
    const url = (0, exports.getDownloadUrl)(version, os, arch);
    const response = yield axios_1.default.get(url, {
        url,
        method: "GET",
        responseType: "arraybuffer",
    });
    yield fs_1.default.writeFileSync(outputPath, response.data);
    return path_1.default.resolve(outputPath);
});
exports.downloadAtmos = downloadAtmos;
const getDownloadUrl = (version, os, arch) => `https://github.com/cloudposse/atmos/releases/download/v${version}/atmos_${version}_${os}_${arch}`;
...
const download_1 = __nccwpck_require__(6798);
...
const downloadCLI = (version, os, arch, path) => __awaiter(void 0, void 0, void 0, function* () {
    const url = (0, download_1.getDownloadUrl)(version, os, arch);
    core_1.default.debug(`Downloading Atmos CLI from ${url}`);
    const cliPath = yield (0, download_1.downloadAtmos)(version, os, arch, path);
    return cliPath;
});
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        core_1.default.debug(`Downloading atmos version ${version}: ${osPlatform} ${osArch}`);
        const cliPath = yield downloadCLI(version, osPlatform, osArch, installPath);
        if (!cliPath) {
            throw new Error(`Error occurred downloading version ${version} for ${osPlatform} and ${osArch}`);
        }
        // Install our wrapper
        // if (wrapper) {
        ...
        // }
        // Add to path
        core_1.default.addPath(cliPath);
        core_1.default.setOutput("version", version);
        core_1.default.setOutput("path", cliPath);
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    }
    catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const setup_atmos_1 = __nccwpck_require__(2079);
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, setup_atmos_1.run)();
    });
})();
